...
public class MessageHubConsoleSample {
    ...
    private static final String ADMINRESTURL = "https://kafka-admin-prod02.messagehub.services.eu-gb.bluemix.net:443";
    private static final String APIKEY = "woVGhRPjLyOWFbVuGLSpUYITPcKEIv51GkFHRlffvRhui8kg";
...
//                }
                ...
                resourceDir = userDir + File.separator + "src";

//                bootstrapServers = args[0];
//                adminRestURL = args[1];
//                apiKey = args[2];
              bootstrapServers = BOOTSTRAPSERVERS;
              adminRestURL = ADMINRESTURL;
              apiKey = APIKEY;                
